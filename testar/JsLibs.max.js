...
(function(window,document,Laya){
	...
	*/
	...
	var TestCamera=(function(){
		...
		var __proto=TestCamera.prototype;
		//getLocation();
		__proto.initVideo=function(){
			this.video.src="Data/output_4.ogg";
			this.beginWork(this.video);
		}
		...
		__proto.initCamaraVideo=function(){
			var _$this=this;
			var navigator=Browser.window.navigator;
			...
			if (navigator.getUserMedia){
				navigator.getUserMedia(videoObj,function(stream){
					_$this.video.src=stream;
					_$this.video.onloadedmetadata=function (e){
						_this.beginWork(_$this.video);
					};
				},errBack);
			}
				...
				navigator.webkitGetUserMedia(videoObj,function(stream){
					_$this.video.src=Browser.window.webkitURL.createObjectURL(stream);
					_$this.video.onloadedmetadata=function (e){
						_this.beginWork(_$this.video);
					};
				},errBack);
				...
				navigator.mozGetUserMedia(videoObj,function(stream){
					_$this.video.src=Browser.window.URL.createObjectURL(stream);
					_$this.video.onloadedmetadata=function (e){
						_this.beginWork(_$this.video);
					};
				},errBack);
		...
		__proto.camaraLoaded=function(){
			...
			Laya.timer.frameLoop(5,this,this.loop);
		}
